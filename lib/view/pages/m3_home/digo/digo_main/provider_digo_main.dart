...
class ProviderDigoMain extends ChangeNotifier {
  ...
  getAllData({required String pageNum}) async {
    try {
      ...
      notifyListeners();
      var response = await dio.get("http://api.uzbmb.uz/v1/digo/index?page=$pageNum&per-page=5",
          options: Options(
              headers: {"X-Access-Token": "79f72f809904f4dba5df3b410d66b7e4"}));
  ...
  String getFanName({required int index}) {
    return box.get("lang").toString() == "1" ||
        ...
        : box.get("lang").toString() == "2"
            ? listDatum[index].order[0].dir.fanOne.nameQq
                .toString()
            : listDatum[index].order[0].dir.fanOne.nameRu
                .toString();
  }
  ...
  String getFanName2({required int index}) {
    return box.get("lang").toString() == "1" ||
        ...
        : box.get("lang").toString() == "2"
            ? listDatum[index].order[0].dir.fanTwo.nameQq
                .toString()
            :listDatum[index].order[0].dir.fanTwo.nameRu
                .toString();
  }
  ...
  String getLangKitob({required int index}) {
    return box.get("lang").toString() == "1" ||
        ...
        : box.get("lang").toString() == "2"
            ...
            : listDatum[index].order[0].dir.lang.nameRu
                .toString();
  }
}
