            ...
            Row(
              ...
              children: [
                MaterialButton(
                    ...
                    color: Colors.teal,
                    onPressed: () {
                      Navigator.push(context, CupertinoPageRoute(builder: (context) => Digo(),));
                    },
                    child: Text(
                      "order".tr(),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Clipboard.setData(ClipboardData(
                                      text: providerDigoMain.listDatum[index].invoice.toString(),
                                    ));
                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                        duration: const Duration(seconds: 1),
                                        content: Text("${"copy".tr()} ${providerDigoMain.listDatum[index].invoice.toString()}",
                                        )));
                                  },
                                  child: Text(
                                ...
                                Text("${"cost".tr()} : ${providerDigoMain.listDatum[index].pay
                                                  .toString() ==
                                                  "0"
                                                  ? "noPayed".tr()
                                                  : "payed".tr()}",
        ...
        builder: (context, value, child) => SafeArea(
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Colors.white,
              elevation: 0,
              title: Text("digoTest".tr(), style: const TextStyle(fontWeight: FontWeight.bold)),
              centerTitle: true,
