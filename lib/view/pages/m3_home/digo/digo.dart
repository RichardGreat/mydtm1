        ...
        child: ListView(
          children: [
            ...
            Card(
              ...
              child: ListTile(
                onTap: () {
                  providerDigo.regName.toString().length > 4
                      ? getRegionSheet(
                          context: context1,
                      ...
                      : {
                          MyWidgets.awesomeDialogError(
                              context: context, valueText: "fillUp".tr())
                        };
                },
                leading: Text(
            ...
            Card(
              ...
              child: ListTile(
                onTap: () {
                  providerDigo.fan1Name.toString().length > 4
                      ? getRegionSheet(
                          context: context1,
                          providerDigo: providerDigo,
                          index: 3)
            ...
            Card(
              ...
              child: ListTile(
                onTap: () {
                  providerDigo.fan2Name.toString().length > 4
                      ? getRegionSheet(
                          context: context1,
                          providerDigo: providerDigo,
                          index: 4)
            ...
            Card(
              ...
              child: ListTile(
                onTap: () {
                  providerDigo.langName.toString().length > 4
                      ? getRegionSheet(
                          context: context1,
                          providerDigo: providerDigo,
                          index: 5)
                  ...
                  MaterialButton(
                    onPressed: () {
                      if (providerDigo.regName.isEmpty ||
                        ...
                        MyWidgets.awesomeDialogError(
                            context: context, valueText: "fillAll".tr());
                        // getRegionSheet(
                        //     context: context1,
                        //     providerDigo: providerDigo,
              ...
              GestureDetector(
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      ...
                      content: Text(
                        "${"copy".tr()} ${providerDigo.modelGetNatija.data[0].invoice}",
                      )));
                },
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: MediaQuery.of(context).size.width * 0.4,
                      child: Text(
                          providerDigo.modelGetNatija.data[0].invoice
                              .toString(),
                          style: const TextStyle(fontWeight: FontWeight.w600),
                          textAlign: TextAlign.start),
                    ),
              ...
              GestureDetector(
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      duration: const Duration(seconds: 1),
                      content: Text(
                        "${"copy".tr()} ${providerDigo.modelGetNatija.data[0].invoice.toString()}",
                      )));
                },
                child: QrImageView(
