...
Widget bodySmsEdu(
    {required BuildContext context, required providerSmsEdu providerSmsEduEdu}) {
  return    Column(
    mainAxisAlignment: MainAxisAlignment.start,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      providerSmsEdu.timeFormatString == "00:00"?const SizedBox.shrink():
      Text("smsSent".tr(),
          style: TextStyle(
              fontSize: 17,
      ...
      Row(
        ...
        children: [
          SizedBox(
            ...
            child: TextFormField(
              controller: providerSmsEdu.controller,
              maxLines: 1,
              maxLength: 6,
          ...
          Align(
            ...
            child:MyWidgets.robotoFontText(
                text:providerSmsEdu.timeFormatString??"05:00",
                textSize: 16
            ),
          ),
