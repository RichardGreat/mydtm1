                ...
                child: box.get("token").toString().length > 30
                    ? Container(
                        ...
                        child: providerCheckCertificate.boolGetCertInfo
                            ? SafeArea(
                                child: providerCheckCertificate
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: ListTile(
                                                              ...
                                                              trailing: Text(
                                                                getBallFormat(providerCheckCertificate
                                                                    .modelCheckCert[
                                                                        0]
                                                                    .data[
                                                                        index2]
                                                          ...
                                                          leading: Text(
                                                              ...
                                                              style: const TextStyle(
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .bold)),
                                                          trailing: providerCheckCertificate
                                                                      .modelCheckCert[
                                                                          0]
                                                                      .data[
                                                                          index2]
                                                              ...
                                                              ? CountDownText(
                                                                  due: DateTime.parse(
                                                                      "${providerCheckCertificate.modelCheckCert[0].data[index2].endDate.toString().substring(
                                                                            6,
                                                              ...
                                                              : CountDownText(
                                                                  due: DateTime.parse(providerCheckCertificate
                                                                      .modelCheckCert[
                                                                          0]
                                                                      .data[
                                                                          index2]
