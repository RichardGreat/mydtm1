...
Widget bodyCertificate(
  ...
  return providerCertificate.boolCheckForeignLang ? providerCertificate.boolCheckCertificateData
  ? Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Chet tili"),
              Container(height: 200,color: MyColors.appColorBlue1(),
              child: Column(
                children: [
                  MyWidgets.robotoFontText(text:"providerCertificate.dataCheckForeignCertificate.flangCertName")
                ],
              ),
              ),
                  ...
                  margin: const EdgeInsets.only(top: 5, bottom: 5),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          providerCertificate
                              .listCheckCertificate[index].percent + " %",
                          style: TextStyle(
      ...
      : MyWidgets.loaderDownload(context: context): MyWidgets.loaderDownload(context: context);
}
