                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: MyColors.appColorGrey400(), width: 1)),
                        child: Row(
                            children: [MyWidgets.robotoFontText(text: imie)]),
                      ),
                            ...
                            child: TextFormField(
                              ...
                              validator: (value3) {
                                if (value3!.isEmpty || value3.length < 7) {
                                  providerPersonInfo.boolPsNumber(
                                      boolNum: false);
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              if (providerPersonInfo
                                          .txtPsSerController.text.length ==
                                      2 &&
                                  providerPersonInfo
                                          .txtPsNumController.text.length ==
                                      7) {
                                providerPersonInfo.setPersonAgain(
                                    function1: providerPersonInfo.functionBosh,
                                    context: context,
                                    psSer: providerPersonInfo
                                        .txtPsSerController.text,
                                    psNum: providerPersonInfo
                                        .txtPsNumController.text);
                              } else {
                                log("##");
                              }
                            },
