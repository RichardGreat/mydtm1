  ...
  return Expanded(
      child: Column(
        ...
        child: MyWidgets.robotoFontText(
            text: "Ro'yxatdan o'tish", textColor: MyColors.appColorWhite()),
        onPressed: () {
          ...
          providerSignUp.getRegistration(context: context);
            ...
            MyWidgets.scaffoldMessengerBottom(context: context, valueText: "Maydonlarni to'ldirilganini tekshiring");
          }
